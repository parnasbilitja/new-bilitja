            ...
            <div className="image-slider-main-container">
                {
                    images.map((image, index) => (
                        <img src={image} className={`${index == this.state.currentImage ? "visible-image" : null}`} />
                    ))
                }
                <div className="button-slide next" onClick={() => {
                ...
                <div className="button-slide previous" onClick={() => {
                ...
                <div className="image-slider-tumbs-container">
                    {
                        images.map((image, index) => (
                            <div className={`tumbs ${index == this.state.currentImage ? "active-image" : null}`} onClick={() => {
                                this.setState({
                                    currentImage:index
                                })
                            }}>
