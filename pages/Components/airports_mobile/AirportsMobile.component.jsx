...
import "../../../styles/AirportsMobile.module.scss"
                ...
                <div className="mobile-airport-list">
                    {
                        ...
                        this.props.airports ?
                            this.props.credenrialType != "source" ?
                                ...
                                this.props.airports.filter(oneAirport => oneAirport.airportName != this.props.credentials.sourceName && oneAirport.airportKey.includes(this.props.searchTerm)).map(oneAirport => (
                                    <div key={oneAirport.airportKey} onClick={() => {

                                        this.changeRoute(oneAirport)
                                    }}>
                                        <span>{oneAirport.airportName}</span>
                                        <span className="pull-left">{oneAirport.airportCode}</span>
                                    </div>
                                ))
                                :
                                this.props.airports.filter(oneAirport => oneAirport.airportKey.includes(this.props.searchTerm)).map(oneAirport => (
                                    <div key={oneAirport.airportKey} onClick={() => {
