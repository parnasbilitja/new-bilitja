        ...
        <div className="suggestion-box">
            {
                ...
                props.airports ?
                    props.credenrialType != "source" ?
                        ...
                        props.airports.filter(oneAirport => oneAirport.airportKey.includes(props.searchTerm) && oneAirport.airportName != props.credentials.sourceName).map(oneAirport => (
                            <div key={oneAirport.airportKey} onClick={() => {
                                ...
                                <span className="font-size-14">{oneAirport.airportName}</span>
                                <span className="pull-left font-size-13 color-textpill">{oneAirport.airportCode}</span>
                            </div>
                        ))
                        :

                        props.airports.filter(oneAirport => oneAirport.airportKey.includes(props.searchTerm)).map(oneAirport => (
                            <div key={oneAirport.airportKey} onClick={() => {
