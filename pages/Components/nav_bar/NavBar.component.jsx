            ...
            <nav id={s.navVar}>
                ...
                <div className="nav-items-container">
                    <ul className="navbar-items">
                        ...
                        <li>
                            <a href="/ویلا">
                                <i className="kilo-font icon-villa nav-icon"></i>
                                اقامتگاه
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i className="kilo-font icon-blog nav-icon"></i>
                                بلاگ
                            </a>
                        </li>
                        <li>
                            <a href="/بلیط-هواپیما/order">
                                <i className="kilo-font icon-refrence nav-icon"></i>
                                پیگیری خرید
                            </a>
                        </li>
                    </ul>
                ...
                <div className="nav-logo-container">
                    <div>
                        <a href="/">
                            <img className="logo" src="../../../public/images/logo512.png" />
                        </a>
