...
import '../../../styles/MobileFlightList.module.scss'
    ...
    render() {
        return (
            <div className="container-flight-list-mobile">
                <div>
                    <div className="mobile-flight-list-header font-bold-iransanse">
                    ...
                    </div>
                    {
                        this.props.flightList.map(oneFlight => (
                            <div key={oneFlight.flightId} className="mobile-flight-list-one-row">
                                <div className="mobile-one-row-price">
                                    <div>
                                ...
                                <div>
                                    <div className="mobile-one-row-time">
                                    ...
                                    <div className="mobile-one-row-cap">
