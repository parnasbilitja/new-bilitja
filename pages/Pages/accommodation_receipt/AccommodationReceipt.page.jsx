...
import { selectProperties } from '../../Redux/ReserveAccommodation/reserve_accommodation.reselect'
...
class AccommodationReceipt extends React.Component {
    ...
    validation = () => {
        ...
        let validated= true
        if (this.state.NameFamily == null || this.state.NameFamily == "" || this.state.NameFamily == undefined) {
            errors['familyErr'] = "لطفا نام و نام خانوادگی خود را وارد کنید"
            validated=false
        }
        if (this.state.NationalCode == null || this.state.NationalCode == "" || this.state.NationalCode == undefined) {
            errors['nationalCodeErr'] = "لطفا کد ملی خود را وارد کنید"
            validated=false
        }
        if (this.state.MobileNo == null || this.state.MobileNo == "" || this.state.MobileNo == undefined) {
            ...
            <div className="container-fluid accommodation-receipt">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-10 col-12">
                        <h1 className="border-bottom-black font-size-18 text-right padding-5px">اطلاعات رزرو شماره TJq4rS</h1>
                        <div className="row">
                            <div className="col-lg-8 col-md-8 col-sm-12 col-12">
                                <div className="border-pill text-right">
                                    <div className="border-bottom-black padding-10px">
                                        <h1 className="font-size-20 font-bold-iransanse">استخردار مستقل شیک در چالوس</h1>
                                    </div>
                                    <div className="row padding-10px">
                                        <div className="col-lg-4 col-md-4 col-sm-4 col-6">
                                            <FontAwesomeIcon icon={faClock} />
                                            <span> شهر : {this.props.selectProperties.CityName} </span>
                                        </div>
                                        <div className="col-lg-4 col-md-4 col-sm-4 col-6">
                                            <FontAwesomeIcon icon={faClock} />
                                            <span> محدوده  :  {this.props.selectProperties.AddressName} </span>
                                        </div>
                                        <div className="col-lg-12 col-md-4 col-sm-4 col-6">
                                            <FontAwesomeIcon icon={faClock} />
                                            <span> آدرس  : {this.props.selectProperties.Address} </span>
                                        </div>
                                    </div>
                                </div>
                                <br />
                            ...
                            <div className="col-lg-4 col-md-4 col-sm-12 col-12 text-right">
                                <div className="border-pill padding-5px">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-5 col-5 border-pill padding-5px">
                                            <span className="font-size-13">
                                                ...
                                                &nbsp;تاریخ ورود : {this.props.selectProperties.selectedDaysArray[0][0]}
                                            </span>
                                        </div>
                                        &nbsp;&nbsp;
                                        <div className="col-lg-5 col-5 border-pill padding-5px">
                                            <span className="font-size-13">
                                                <FontAwesomeIcon icon={faCalendar} />
                                                &nbsp;تاریخ خروج :{this.props.selectProperties.selectedDaysArray[this.props.selectProperties.selectedDaysArray.length - 1][0]}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="font-size-14 padding-10px">
                                        {
                                            this.props.selectProperties.selectedDaysArray.map(day => (
                                                <div className="row">
                                        ...
                                        <span className="pull-left">
                                            {this.props.selectProperties.selectedDaysArray.reduce((a, b) => a + (b[1] || 0), 0)} تومان
                                        </span>
                                        <span>
                                            مبلغ کل
                                        </span>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-5 col-5 no-padding">
                                            <a className="btn-encouregment" onClick={() => {
                                                ...
                                                const requestObject = {
                                                    EghamatId: parseInt(this.props.selectProperties.EghamatId),
                                                    RoomRow: this.props.selectProperties.RoomRow,
                                                    DateInc: this.props.selectProperties.DateInc.replace("/", "").replace("/", ""),
                                                ...
                                                fetch(`${globals.baseUrl}bj/site/reserve`, {
                                                    ...
                                                    .then(json => {
                                                        if (json.status == "OK") {
                                                            ...
                                                            window.open(`Https://bilitja.ravis.ir/ApplicationBank/CallBank?reqNo=${properties[0]}&reqPnr=${properties[1]}`)
                                                        } else {
                                            ...
                                            }}>پرداخت با کارت شتاب</a>
                                        </div>
                                        &nbsp;&nbsp;
                                        <div className="col-lg-5 col-5 no-padding">
                                            <PrimaryButton style={{ fontSize: 14 }} value={"پرداخت از کیف پول"} />
                                        </div>
                                    </div>
                                    <div className="padding-horizental-10px">
                                        <a className="btn-outlined-cancle-tall" style={{ marginTop: 8, marginRight: 5 }}>بازگشت</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default connect(mapStateToProps, dispatchStateToProps)(AccommodationReceipt) 