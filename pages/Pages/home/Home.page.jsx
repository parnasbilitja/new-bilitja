        ...
        return (
            <div>
                ...
                <div className="hero-big-image">
                    <img src='../../../public/images/flight-index.png' />
                </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-5 col-md-6 col-sm-12 padding-5px">
                                <div className="home-value-propsal">
                                    <img src="../../../public/images/service1.png" />
                                    <h3 className="font-bold-iransanse">
                                        <span>خرید بلیط هواپیما &nbsp;</span>
                                        <span className="color-primary">با چند کلیک</span>
                                    </h3>
                                    <p className="color-textpill font-size-14">کافیست در صفحه خرید بلیط هواپیما مبدا، مقصد و روز را وارد کرده و ارزانترین بلیط هواپیما را از میان پروازهای چارتری، سیستمی و لحظه آخری انتخاب کنید.</p>
                                </div>
                            </div>
                            <div className="col-lg-5 col-md-6 col-sm-12 padding-5px">
                                <div className="home-value-propsal">
                                    <img src="../../../public/images/service3.png" />
                                    <h3 className="font-bold-iransanse">
                                        <span className="color-primary">پذیرش میزبانی &nbsp;</span>
                                        <span>ویلا و اقامتگاه</span>
                                    </h3>
                                    <p className="color-textpill font-size-14">با عضویت در سامانه بلیطجا شما هم میتوانید ویلا یا اقامتگاه خود را در معرض بازدید و رزرو گردشگران و سایر آژانس های گردشگردی قرار دهید.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row">
                    ...
                    <div className="col-md-10 home-tour-intro">
                        ...
                        <div>
                            ...
                            <a href="#" className="pull-left btn-fiiled">جستجوی مقاصد</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="suggestion-list">
                            <div>
                                <a href="بلیط-هواپیما/تهران/مشهد/">
                                    ...
                                    <span className="pull-right font-size-14">بلیط هواپیما مشهد</span>
                                </a>
                            ...
                            <div>
                                <a href="بلیط-هواپیما/تهران/اصفهان">
                                    <i className="kilo-font font-size-24 icon-plane-departure pull-right"></i>
                                    <span className="pull-right font-size-14">بلیط هواپیما کیش</span>
                                </a>
                                <div className="clear"></div>
                            </div>
                            <div>
                                <a href="بلیط-هواپیما/تهران/مشهد">
                                    <i className="kilo-font font-size-24 icon-plane-departure pull-right"></i>
                                    <span className="pull-right font-size-14">بلیط هواپیما اصفهان</span>
                                </a>
                                <div className="clear"></div>
                            </div>
                            <div>
                                <a href="بلیط-هواپیما/تهران/اهواز">
                                    <i className="kilo-font font-size-24 icon-plane-departure pull-right"></i>
                                    <span className="pull-right font-size-14">بلیط هواپیما اهواز</span>
                                </a>
                                <div className="clear"></div>
                            </div>
                            <div>
                                <a href="بلیط-هواپیما/تهران/تبریز">
                                    <i className="kilo-font font-size-24 icon-plane-departure pull-right"></i>
                                    <span className="pull-right font-size-14">بلیط هواپیما تبریز</span>
                                </a>
                                <div className="clear"></div>
                            </div>
                            <div>
                                <a href="بلیط-هواپیما/تهران/شیراز">
                                    <i className="kilo-font font-size-24 icon-plane-departure pull-right"></i>
                                    <span className="pull-right font-size-14">بلیط هواپیما شیراز</span>
                                </a>
                                <div className="clear"></div>
                            </div>
                        </div>
                        <div className="suggestion-list">
                            <div>
                                <a href="بلیط-هواپیما/تهران/استانبول">
                                    <i className="kilo-font font-size-24 icon-plane-departure pull-right"></i>
                                    <span className="pull-right font-size-13">بلیط هواپیما استانبول</span>
                                </a>
                                <div className="clear"></div>
                            </div>
                            <div>
                                <a href="بلیط-هواپیما/تهران/دبی">
                                    <i className="kilo-font font-size-24 icon-plane-departure pull-right"></i>
                                    <span className="pull-right font-size-14">بلیط هواپیما دبی</span>
                                </a>
                                <div className="clear"></div>
                            </div>
                            <div>
                                <a href="بلیط-هواپیما/تهران/تفلیس">
                                    <i className="kilo-font font-size-24 icon-plane-departure pull-right"></i>
                                    <span className="pull-right font-size-14">بلیط هواپیما تفلیس</span>
                                </a>
                                <div className="clear"></div>
                            </div>
                            <div>
                            ...
                            <div>
                                <a href="بلیط-هواپیما/تهران/باکو">
                                    <i className="kilo-font font-size-24 icon-plane-departure pull-right"></i>
                                    <span className="pull-right font-size-14">بلیط هواپیما باکو</span>
                                </a>
                                <div className="clear"></div>
                            </div>
                            <div>
                                <a href="بلیط-هواپیما/تهران/نجف">
                                    <i className="kilo-font font-size-24 icon-plane-departure pull-right"></i>
                                    <span className="pull-right font-size-14">بلیط هواپیما نجف</span>
                                </a>
                                <div className="clear"></div>
                            </div>
                        </div>
