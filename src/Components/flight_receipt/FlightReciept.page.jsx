...
import PopUpWide from '../../Components/pop_up_wide/PopUpWide.component'
import FlightPassengerEditForm from '../../Components/flight_passenger_edit_form/FlightPassengerEditForm.component'
class FlightReciept extends React.Component {
    ...
    componentDidMount() {
        fetch(`${globals.baseUrl}flightsReserve/ravisReserveProperty/${this.props.reserveProperties.reqNo}-${this.props.reserveProperties.reqPnr}`)
            ...
            .then(data => {
                console.log(data)
                if (data.status == "0") {
                    const birthDayAll = String(data.flightReservePropertyModel.birthDayAll).split(",")
                    const familyAll = String(data.flightReservePropertyModel.familyAll).split(",")
                    const meliCodeAll = String(data.flightReservePropertyModel.meliCodeAll).split(",")
                    const meliatAll = String(data.flightReservePropertyModel.meliatAll).split(",")
                    ...
                    const ticketCodeAll = String(data.flightReservePropertyModel.ticketCodeAll).split(",")
                    this.setState({
    ...
    getBanks = () => {
        window.open(`Https://bilitja.ravis.ir/ApplicationBank/CallBank?reqNo=${this.props.reserveProperties.reqNo}&reqPnr=${this.props.reserveProperties.reqPnr}`, "_self")
    ...
    getTicketPrice = (type) => {
        switch (type) {
            case "ADL": return this.state.priceADL
            case "CHD": return this.state.priceCHD
            case "INF": return this.state.priceINF
        }
    }
    getAllPrice = () => {
        let sum = 0
        ...
        return (
            <div className="container-fluid">
                                        ...
                                        <tr className="font-size-13">
                                            ...
                                            <td>
                                                ...
                                                <div className="visible-xs font-bold-iransanse">
                                                    <span>
                                                        <FontAwesomeIcon icon={faUser} />
                                                        {`${this.state.nameAll_[index]} ${this.state.familyAll_[index]} (${this.getTicketType(this.state.ticketCodeAll_[index])})`}
                                                    </span>
                                                    <p>
                                            ...
                                            <td className="hidden-xs">{this.state.familyAll_[index]}</td>
                                            <td className="hidden-xs">{this.state.meliatAll_[index] == "IR" ? "ایرانی" : "خارجی"}</td>
                                            <td className="hidden-xs">{this.state.meliCodeAll_[index]}</td>
                                            <td>
                                                <div className="hidden-xs">
                                                ...
                                                <div className="visible-xs font-bold-iransanse">
                                                    ...
                                                    <p>
                                                        ...
                                                        <span className="color-secondary"> {this.getTicketPrice(this.state.ticketCodeAll_[index])}</span>
                                                    </p>
                                                </div>
                                            </td>
                ...
                <div className="row" style={{ marginTop: 10 }}>
                    ...
                    <div className="col-lg-10 col-12 no-padding-xs border-pill-lg" style={{ paddingTop: 10 }}>
                        <div className="row">
                            <div className="col-lg-4 text-right">
                                <div className="row">
                                    <div className="col-lg-7 col-6">
                                        <p className="font-size-13 font-bold-iransanse">مبلغ کل :</p>
                                    </div>
                                ...
                                <div className="row">
                                    <div className="col-lg-7 col-6">
                                        <p className="font-size-13 font-bold-iransanse">اعتبار کیف پول شما :‌</p>
                                    </div>
                                    <div className="col-lg-5 col-6 text-left">
                                        <p className="font-size-13">
                                            {moneyFormat(0)} تومان
                                ...
                                <div className="row">
                                    <div className="col-lg-7 col-6">
                                        <p className="font-size-13 font-bold-iransanse">مبلغ قابل پرداخت :‌</p>
                                    </div>
                                    <div className="col-lg-5 col-6 text-left">
                                        <p className="font-size-13">
                                            {moneyFormat(this.state.priceAll)} تومان
                            ...
                            <div className="col-lg-4 col-12 payment-container text-right">
                                <div className="row">
                                    ...
                                    <div className="col-lg-3 padding-5px">
