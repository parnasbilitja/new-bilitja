...
const TourDetailLabel = ({
  ...
  const getFlightDet = (mode) => {
    let flight;
    if (mode === "departure") {
      flight = flightDet?.departure;
    } else {
      flight = flightDet?.return;
    }
    return flight;
  };
  ...
  return (
    <div className="detail-tour col-xl-12 col-lg-12 col-12 d-flex flex-wrap justify-content-between border-bottom">
      <div className="right col-xl-5 col-lg-5 col-12">
        <>
          ...
          >
            ...
            <p style={{ fontSize: "14px", fontWeight: "bolder" }}>{refcode}</p>
          </div>
          <div className="gallery-image">
            {gallary.length > 0 ? (
              <img
                src={gallary && gallary[0]?.url}
                width={"100%"}
                alt={`${getFlightDet("departure")?.destination_name} ${
      ...
      <div
        className="left position-relative col-xl-7 col-lg-7 col-12 "
      ...
      >
        ...
        <div className="p-info__tour mr-0 d-flex flex-wrap align-items-center justify-content-between col-xl-12 col-lg-12 me-3 ">
              ...
              <div className="text w-90-mobi m-flex-100 pe-2">
                <div className="m-main-data d-flex flex-between-mobi align-items-center pb-1">
                  <div className="val pe-2 m-pr-15 mb-0">
                    <div className="d-flex justify-content-between">
                      ...
                      >
                        {getFlightDet("departure")?.origin_name}
                      </p>
                      <p
                        style={{
                          margin: 0,
                      ...
                      >
                        {getFlightDet("departure")?.destination_name}
                      </p>
                    </div>
                  </div>
                </div>
                <div className="val pe-2 m-pr-15 mb-0">
                  <div className="d-flex justify-content-between">
                    ...
                    >
                      {getFlightDet("departure")?.flight?.airline_name}
                    </p>
                  </div>
                </div>
                <div className="m-main-data d-flex flex-between-mobi align-items-center pb-1 m-pb-7">
                  <div className="prop d-flex align-items-center">
                    ...
                    <span
                      ...
                      style={{ fontSize: "14px" }}
                    >
                      تاریخ و ساعت پرواز رفت
                    </span>
                  </div>
                  <div className="val pe-2">
                    <span
                      className="font-13-mobi bold-900-mobi"
                      style={{ fontSize: "13px", fontWeight: "600" }}
                    >{` ${dateReform(
                      getFlightDet("departure")?.time
                    )} | ${getDayInPersian(
                      moment(getFlightDet("departure")?.date)?.format("dddd")
                    )} ${MiladiToJalaliConvertor(
                      getFlightDet("departure")?.date
                    )}`}</span>
                  </div>
                </div>
              </div>
          ...
          {/* border */}
          <div
            className="border-style-tour isMobile"
            style={{ display: "none" }}
          ></div>
          {/* c info */}
          <div className="c-info__tour bg-white d-flex align-items-center justify-content-center box-shadow-sm col-xl-12 col-lg-12 col-12 my-4 m-my-20">
            ...
            <div
              className="text flex-between-mobi w-100-mobi d-flex align-items-center justify-content-center m-justify-content-between px-2 m-px-0 bg-white rounded shadow-sm h-25 py-2"
              style={{ zIndex: 1000 }}
            >
              <div className="text d-flex align-items-center m-pr-6">
                ...
                >
                  ...
                  >
                    ...
                    <path
                      ...
                      transform="translate(6.265 1.09)"
                      fill="none"
                      stroke="#e20000"
                      strokeLinecap="round"
                      strokeWidth="2"
                ...
                <span className="font-13-mobi text-danger bold-900-mobi font-bold">
                  مدت اقامت
                </span>
              </div>
          ...
          <div className="c-info__tour d-flex flex-row-reverse align-items-center col-xl-12 col-lg-12 col-12">
            <div className="bg-white py-3">
              <div className="image d-flex align-items-center bg-white rounded shadow-sm py-3 px-3 isDesktop">
                <img
                  src={getFlightDet("return")?.airline_logo?.url}
                  width={"35px"}
                  height={"35px"}
                  alt="company"
                  style={{ objectFit: "cover" }}
            ...
            <div className="text w-90-mobi m-flex-100 p-0-mobi pe-2 ps-3">
                ...
                <div className="m-main-data d-flex flex-between-mobi align-items-center ">
                  <div className="val pe-2 m-pr-15 mb-0">
                    <div className="d-flex justify-content-between">
                      ...
                      >
                        {getFlightDet("return")?.origin_name}
                      </p>
                      <p
                        style={{
                          margin: 0,
                      ...
                      >
                        {getFlightDet("return")?.destination_name}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="val pe-2 m-pr-15 mb-2">
                <div className="d-flex justify-content-lg-end">
                  ...
                  >
                    {getFlightDet("return")?.flight?.airline_name}
                  </p>
                </div>
              </div>
              <div className="m-main-data flex-between-mobi d-flex flex-row-reverse align-items-center pb-1 m-pb-7">
                ...
                <div className="val pe-2">
                  <span
                    ...
                    style={{ fontSize: "13px", fontWeight: "600" }}
                  >{` ${dateReform(
                    getFlightDet("return")?.time
                  )} | ${getDayInPersian(
                    moment(getFlightDet("return")?.date).format("dddd")
                  )} ${MiladiToJalaliConvertor(
                    getFlightDet("return")?.date
                  )}`}</span>
                </div>
              </div>
            </div>
