...
const TourDetailLabel = ({ hotelName,flightDet, stayCount,gallary ,refcode}) => {
...
<div className='d-flex align-items-center'>
  <div className="bg-white py-3">
    <div className="image d-flex align-items-center bg-white rounded shadow-sm py-3 px-3 isDesktop">
      <img src={getFlightDet('departure')?.airline_logo?.url} width={"35px"} height={"35px"} alt="company" style={{ objectFit: 'cover' }} />
    </div>
  </div>
  <div className="text w-90-mobi m-flex-100 pe-2">
    ...
    <div className="m-main-data d-flex flex-between-mobi align-items-center pb-1 m-pb-7">
      ...
      <div className="val pe-2">
        <span className="font-13-mobi bold-900-mobi" style={{fontSize:'13px', fontWeight:'600'}}>{` ${dateReform(getFlightDet('departure')?.time)} | ${getDayInPersian(moment(getFlightDet('departure')?.date)?.format('dddd'))} ${MiladiToJalaliConvertor(getFlightDet('departure')?.date)}`}</span>
      </div>
    </div>
      ...
      <div className="c-info__tour d-flex flex-row-reverse align-items-center col-xl-12 col-lg-12 col-12">
        <div className="bg-white py-3">
          <div className="image d-flex align-items-center bg-white rounded shadow-sm py-3 px-3 isDesktop">
            ...
            <img src={getFlightDet('return')?.airline_logo?.url} width={"35px"} height={"35px"} alt="company" style={{ objectFit: 'cover' }} />
        ...
        <div className="text w-90-mobi m-flex-100 p-0-mobi pe-2 ps-3">
          ...
          <div className="m-main-data flex-between-mobi d-flex flex-row-reverse align-items-center pb-1 m-pb-7">
            ...
            <div className="val pe-2">
              <span className="font-13-mobi bold-900-mobi" style={{fontSize:'13px', fontWeight:'600'}}>{` ${dateReform(getFlightDet('return')?.time)} | ${getDayInPersian(moment(getFlightDet('return')?.date).format('dddd'))} ${MiladiToJalaliConvertor(getFlightDet('return')?.date)}`}</span>
            </div>
