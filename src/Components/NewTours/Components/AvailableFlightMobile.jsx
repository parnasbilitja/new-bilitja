          ...
          <div className={styles["container"]}>
              ...
              <>
                      ...
                      <div className={styles["flight_company"]}>
                        ...
                        <p style={{whiteSpace:'nowrap'}}>رفت</p>
                          ...
                          <div className={styles["flight_info"]}>
                            ...
                            <div>
                              <p style={{color:'#e20000',fontSize:'17px'}}>{flight?.departure?.time.slice(0, 5)}</p>
                            </div>
                          </div>
                        </div>
                        <div className={styles["flight_company_remaintour"]}>
                          <p style={{ whiteSpace: "nowrap" }}>
                            تعداد موجودی پرواز :<span style={{color:'#e20000',fontWeight:'900',fontSize:'13px'}}>{minCapacity(flight) }</span>
                          </p>
                          <div
                            style={{
                              display: "flex",
                        ...
                        <div className={styles["flight_company_logo"]}>
                          ...
                          <div className={styles["flight_info"]}>
                            ...
                            <div>
                              <p style={{color:'#e20000',fontSize:'17px'}}>{flight?.return?.time.slice(0, 5)}</p>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div className={styles["ticket_reserve"]} >
                  <div className={styles["ticket_reserve_price"]} ref={el => collapseRefs.current[flight.departure.id.toString()+flight.return.id.toString()] = el}>
                                                                ...
                                                                >
                                                                  <div>
                                                                    <div style={{
                                                                      ...
                                                                      <p className={styles['age_range']}>(بالای 12 سال)</p>
                                                                    </div>
                                                                ...
                                                                >
                                                                  ...
                                                                  >
                                                                    <div   style={{
                                                                      ...
                                                                      <p className={styles['age_range']} style={{fontSize:'10px !important'}}>({chdAgeStr(hotel?.hotel?.no_bed_child_ages[0],hotel?.hotel?.no_bed_child_ages[1])})</p>
                                                                    </div>
                                                                    <p className={styles["bedtypeprc"]}>
                                                                      {/*{numberWithCommas(*/}
                                                                      {/*    numberRounder(*/}
                                                                ...
                                                                >
                                                                  ...
                                                                  >
                                                                    <div style={{
                                                                      ...
                                                                      <p className={styles['age_range']}>(زیر 2 سال)</p>
                                                                    </div>
                                                                    <p className={styles["bedtypeprc"]}>
                                                                      {/*{numberWithCommas(*/}
