...
const AvailableFlightBasedonSelectedTour = (props) => {
    ...
    useEffect(() => {
        console.log('sada', props.widthmobi)
    }, [])
        ...
        <>
            ...
            <div className={styles["container"]}>
                            ...
                            <div className={styles["left"]}>
                                {hotel?.gallery && (
                                    <div className={styles["image_container"]}>
                                        ...
                                        <Image className={styles["img-big"]}
                ...
                <div className={styles["subscription"]}>
                    <p className={styles["p-title-page"]}>با بررسی زمان پرواز و قیمت اتاق ها تور خود را انتخاب کنید</p>
                </div>
                                            ...
                                            <div className={styles["flightDet_container"]}>
                                                ...
                                                <div className={styles["flight_company"]}>
                                                    ...
                                                    <div className={styles["flight_company_remaintour"]}>
                                                        <p className={styles["p-middle"]}>تعداد موجودی پرواز
                                                            :{flight.capacity}</p>
                                                    </div>
                                                    <div className={styles["flight_company_logo"]}>
                                                        <div className={styles["image_container"]}>
