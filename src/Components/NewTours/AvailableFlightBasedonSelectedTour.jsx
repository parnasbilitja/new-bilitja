   ...
   return  Math.min(flight?.departure.capacity,flight?.return.capacity)
    ...
    let targetedRoom=hotel.rooms.filter(room=>room.room_type_id===148)
        if(targetedRoom.length>0){
            ...
            // targetedRoom[0]?.services.map(s=>{
            //     totalprice+=s.rate
            //         // * targetedRoom[0].Adl_capacity
            // })
            ...
            // hotel.rooms[0]?.services.map(s=>{
            //     totalprice+=s.rate
            //         // * hotel.rooms[0].Adl_capacity
            // })
    ...
    useEffect(() => {
        ...
        //     hotelFnName && hotelFnName.length > 2 ? hotelFnName[2] : null;
            ...
            // debugger
        console.log(jalaliToMiladiConvertor(router.query.stDate))
            axios
                .post(
                                    ...
                                    {hotel?.hotel?.gallery && (
                                        <div className={styles["image_container"]}>
                                            <div className={styles["images"]}>
                                                {picGen(hotel?.hotel?.gallery.length - 1).map((pic) => {
                                                    return pic;
                                                })}
                                                <motion.div
    ...
    {hotel?.flights ? (
        hotel?.flights.sort((a,b)=> getDoublePrc(a)-getDoublePrc(b))?.map((flight,index) => {
            return widthMobi > 868 ? (
                (
                    <div className={styles["ticket_container"]} ref={el => collapseRefs.current[flight.departure.id.toString()+flight.return.id.toString()] = el}>
                        <div className={styles["container"]}>
                            <AnimatePresence>
                                        ...
                                        <div className={styles["flight_company"]}>
                                                ...
                                                <div className={styles["image_container"]}>
                                                    {
                                                        flight?.departure.airline_logo?.url ?
                                                            ...
                                                            <img src='Images/noPicture.png' alt=""/>
                                                    }
                                                </div>
                                                <div>

                                                    <p style={{fontSize:'15px',padding:'0',marginBottom:'2px'}}>{flight.departure.airline_name} </p>
                                                    <p style={{fontSize:'12px',padding:'0',margin:'0', color:flight?.departure.cabin_type==='c'? 'red !important':null}}>({flightClass(flight?.departure.cabin_type)})</p>
                                                </div>
                                            </div>
                                            <div className={styles["flight_company_remaintour"]}>
                                                ...
                                                >
                                                    ...
                                                    <svg  style={{transform: "rotate(270deg)"}} fill="#e20000" xmlns="http://www.w3.org/2000/svg" height="30" viewBox="0 -960 960 960" width="30"><path d="M340-80v-60l80-60v-220L80-320v-80l340-200v-220q0-25 17.5-42.5T480-880q25 0 42.5 17.5T540-820v220l340 200v80L540-420v220l80 60v60l-140-40-140 40Z"/></svg>
                                                    {/*<svg*/}
                                            ...
                                            <div className={styles["flight_company_logo"]}>
                                                <div className={styles["image_container"]}>
                                                    {
                                                        flight?.return.airline_logo?.url?
                                                            <img src={flight?.return.airline_logo?.url} alt=""/> :
                                                            <img src='/Images/noPicture.png' alt=""/>
                                                ...
                                                <p style={{fontSize:'15px',padding:'0',marginBottom:'2px'}}>{flight.return.airline_name}</p>
                                                <p style={{fontSize:'12px',padding:'0',margin:'0', color:flight?.return.cabin_type==='c'? 'red !important':null}}>({flightClass(flight?.return.cabin_type)})</p>
                                                </div>
                                            ...
                                            <div className={styles["roomcountDet_container"]} >
                                                <div className={styles["roomcountDet"]}>
                                                    ...
                                                    {room.extra_bed_capacity > 0 &&
                                                        ...
                                                        >
                                                            ...
                                                            <p className={styles["bedtype"]}>
                                                                ...
                                                                <p style={{fontSize:'12px', whiteSpace:'nowrap'}}>(۱۲ سال به بالا)</p>
...

                                                    {
                                                        ...
                                                        >
                                                            <>
                                                                <p className={styles["bedtype"]} >کودک با تخت</p>
                                                            ...
                                                            >
                                                                <div
                                                                    ...
                                                                    onClick={() => {
                                                                        if(room.chd_w_prc>0){incDet1(room, "chd_withbed_count")}else {
                                                    ...
                                                    }
                                                    {
                                                        ...
                                                        >
                                                            <>
                                                                <p className={styles["bedtype"]} >کودک بدون تخت</p>
                                                            <p style={{fontSize:'12px', whiteSpace:'nowrap',textAlign:'center'}} >
                                                            ...
                                                            >
                                                                <div
                                                                    ...
                                                                    onClick={() =>{
                                                                        if(room.chd_n_prc>0){incDet1(room, "chd_nobed_count")}else {
        ...
        <Shimmers/>
            ...
            {
                showInMap && <MapPopUpComponent coordinates={hotel?.hotel?.coordinates} setShowInMap={(val) => setShowInMap(val)}/>
            }
