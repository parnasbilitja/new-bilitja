...
return found_room
  ...
  <span>
                    ...
                    <div className={'isMobile'}>
                        ...
                        {flights.map(flight=>{
                            return (
                                <AvailableFlightMobile       setSelectedRoom={()=>setSelectedRoom(rooms_flightBase_finder2(flight.id))}
                           setIsOpen={()=>setIsOpen(true)}
                                                             setSelectedFlight={()=> setSelectedFlight(flight.id) } flight={flight} price={
                                    numberWithCommas(rooms_flightBase_finder(flight.id, 148)[0].price)
                                }/>
                            )
                        })}
