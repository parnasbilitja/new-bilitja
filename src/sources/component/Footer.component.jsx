...
var body =document.getElementsByTagName("body")
  ...
  return (
    // <div style={{marginTop:'15px',height:'550px'}}>
    ...
    <div className="row parent-footer-top justify-content-between">
      <div className="d-lg-flex align-items-start">
        ...
        <div className="col-lg-4 col-md-12 col-12 col-sm-12 item-footer mb-2">
          ...
          <div className={`px-4 mt-3 ${styles["about-text"]}`}>
            <p>
              سایت بلیطجا با ۱۴ سال سابقه وبادارا بودن مجوز های بند الف و ب از سازمان میراث
          ...
          <div className={`d-flex justify-content-between p-2 mt-4 ${styles["certificates"]}`}>
            <div>
              <a
          ...
          <div className={styles["footer-virtual-mobile"]}>
            <div style={{ marginBottom: 8 }}>
              <div className="d-flex align-items-center justify-content-lg-center mb-2">
                <div className={styles["icon-wrapper"]}>
                  <svg xmlns="http://www.w3.org/2000/svg" width={25} height={25} fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                       stroke="#e20000" className="size-6">
                    <path strokeLinecap="round" strokeLinejoin="round"
                          d="M9 17.25v1.007a3 3 0 0 1-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0 1 15 18.257V17.25m6-12V15a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 15V5.25m18 0A2.25 2.25 0 0 0 18.75 3H5.25A2.25 2.25 0 0 0 3 5.25m18 0V12a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 12V5.25"/>
                  </svg>
                </div>
                <b className="mb-0 mr-2">دسترسی سریع</b>
              </div>
            </div>
            ...
            <div className="mt-4 w-100 d-flex justify-content-center">
              <ul className={styles["ul-lists"]}>
                {footerLinks.map((item, i) => (
                  <li key={i} className={styles["footer-link-item"]}>
        ...
        <div className={`col-lg-4 col-md-12 col-12 col-sm-12 item-footer mb-3 ${styles["footer-contact"]} contact-container`}>
          <div className="d-flex align-items-center mb-2">
            <div className={styles["icon-wrapper"]}>
              <svg xmlns="http://www.w3.org/2000/svg" width={25} height={25} fill="none" viewBox="0 0 24 24"
                   strokeWidth="1.5"
          ...
          <div className={`mb-4 ${styles["map-container"]}`}>
          ...
          <div>
            ...
            <div className="d-flex mb-3">
              ...
              <span className="mr-2 font-size-14">021-84279999</span>
            </div>
            ...
            <div className="d-flex mb-1">
              ...
              <span className="mr-2 font-size-14">واتساپ : 09371000007</span>
            </div>
            ...
            <div className="d-flex justify-content-between mb-3">
              <div className="d-flex justify-content-between align-items-center col-lg-3">
                ...
                <span className="mr-2 font-size-14">info[at]hamnavaz.com</span>
              </div>
              
              <div className={`d-flex justify-content-between col-lg-3 ${styles["contact-us"]}`}>
                <a href="https://instgram.com/hamnavaz.tour" aria-label="Instagram">
                ...
                <a href="https://wa.me/+989102500025" aria-label="WhatsApp">
                  <div className={styles["social-icon"]}>
                    <svg
                      height="22"
                      width="22"
                ...
                <a href="mailto:info@hamnavaz.com" aria-label="Email">
                  <div className={styles["social-icon"]}>
                    <svg
                      height="22"
                      width="22"
                    ...
                    >
                      <g transform="translate(0,-290.65)">
                        <path d="m 5,294.65 c -1.6447,0 -3,1.3553 -3,3 v 10 c 0,1.6447 1.3553,3 3,3 h 14 c 1.6447,0 3,-1.3553 3,-3 v -10 c 0,-1.6447 -1.3553,-3 -3,-3 z m 0.61523,2 h 12.75586 l -6.09179,5.88086 c -0.15622,0.15084 -0.4497,0.15118 -0.60547,0 z M 20,297.85703 V 307.65 c 0,0.5713 -0.4287,1 -1,1 H 5 c -0.5713,0 -1,-0.4287 -1,-1 v -9.7793 l 6.28125,6.09571 c 0.9397,0.91204 2.44471,0.91352 3.38672,0.004 z" />
                      </g>
                    </svg>
                  </div>
                </a>
      ...
      {/* Hidden Desktop Contact - Consider removing if not used */}
      <div 
        style={{ display: "none" }} 
        className={`col-lg-2 col-md-3 col-6 ${styles["contact-desktop"]}`}
      >
        {/* ... existing hidden content ... */}
      </div>
