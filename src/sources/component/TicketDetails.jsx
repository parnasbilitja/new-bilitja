                            ...
                            <div className="d-flex align-items-center justify-content-between">
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="text mx-2">
                                        <p className="font-bold title-custom p-0 my-0 d-flex align-items-center" style={{marginTop:`${width>826?'2px':'4px'}`,fontSize:'18px',padding:'0',fontWeight:'bold',color:'#e20000'}}>درباره آژانس بلبطجا آسمان آبی</p>
