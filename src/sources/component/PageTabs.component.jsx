        ...
        <div className={`col-md-10  ${styles["width-mobile"]} px-0`}>
          <div className={'row justify-content-center me-0 w-100 position-relative'} style={{top:'2px'}}>
            <Link href='/ticket'>
             ...
             <Link href='/hotels'>
            <div className={`col-xl-1 ${styles["tab-home-main"]} ${styles["mobile-tab2"]} col-6 col-md-3 cursor-pointer ${props.type == 3 ? styles["home-tab-active"] : null
            } ${styles["width-full"]}`}
                 onClick={() => {
                   // props.setType(3)
                   // myRouter.push("/tours");
                 ...
                 style={{color: 'gray'}}
            >
              <svg id="_004-hotel" data-name="004-hotel" xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 54.937 52.918">
            ...
            <Link href='/tours'>
              <div className={`${styles["tab-home-main"]} ${styles["mobile-tab4"]} col-6 col-md-2 col-xl-1 cursor-pointer  ${props.type == 2 ? styles["home-tab-active"] : null
              } ${styles["width-full"]}`}
                   onClick={() => {
                     props.setType(2)
                     myRouter.push("/tours");
