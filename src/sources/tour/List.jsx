            ...
            <div className="mt-5 bodyVar">
                <div className="">
                    <div className="d-flex flex-wrap align-items-center justify-content-between mt-5">
                        <div className="d-flex mt-2 flex-column col-xl-4 col-lg-4 col-sm-4 col-12">
                                ...
                                <div className="d-flex align-items-center justify-content-between">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="text mx-2 d-flex justify-content-center flex-column">
                                            <p className="font-bold title-custom p-0 mx-2 my-0 d-flex align-items-center" style={{fontSize:'18px',padding:'0',fontWeight:'bold'}}>لیست تورها</p>
                                            <p className="subtitle-custom font-size-13 m-0">مشاهده مناسب ترین تور های لحظه آخری</p>
                                        </div>
                                    </div>
                                </div>
                                <div className='isMobile' style={{ marginLeft:'0',width:'80px',color:'white',borderRadius:'10px'}}>
                                    <div className='d-flex justify-content-center' style={{padding:'5px'}} >
                                        <div>
                                            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M440-120v-240h80v80h320v80H520v80h-80Zm-320-80v-80h240v80H120Zm160-160v-80H120v-80h160v-80h80v240h-80Zm160-80v-80h400v80H440Zm160-160v-240h80v80h160v80H680v80h-80Zm-480-80v-80h400v80H120Z"/></svg>                                        </div>
                                        <select name="" style={{outline:'none',border:'none',width:'20px'}} id="" value={sortStat} onChange={(e)=>setSortStat(e.target.value)}>
                                            <option value="" disabled={true}>فیلتر براساس....</option>
                                            <option value="prc">قیمت</option>
                                            <option value="dptdate">تاریخ رفت</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div className="c-input col-xl-4 col-lg-4 col-sm-4 col-12 position-relative " style={{width:'180px',height:"50px",display:'flex',justifyContent:'center',alignItems:'center',border:'1px solid #cecece',borderRadius:'10px'}}>
                            <select name="" style={{outline:'none',border:'none',width:'90%'}} id="" value={sortStat} onChange={(e)=>setSortStat(e.target.value)}>
                                <option value="" disabled={true}>فیلتر براساس....</option>
                                <option value="prc">قیمت</option>
                                <option value="dptdate">تاریخ رفت</option>
                            </select>
                            {/*<input type="text" placeholder='مرتب سازی براساس...'/>*/}
                        </div>
                        </div>
                        <div className="c-input col-xl-4 col-lg-4 col-sm-4 col-12 position-relative pt-2">
                            {/*<>*/}
                    ...
                    <div className={`${isShowMore || !Array.isArray(data) || data?.length===0 || !props.hideShowMore ?'auto':'listH'}`} style={{overflowY:'hidden',position:'relative',padding:'8px'}}>
                        {
                            !Array.isArray(data) || data?.length===0  ?
                                ...
                                (sortData(sortStat,data)?.map((item) => (
                    ...
                    <Paginate scrollToTop={props.scrollToTop}  apiCall={(page)=>getTour(city,page)} to={meta.last_page}/>
                    ...
                    {/*        }*/}
                    {/*    }}>*/}
                    {/*        <div style={{width:'110px',height:'50px',color:'#e20000',display:'flex',justifyContent:'center',alignItems:'center',border:'1px solid #e20000',borderRadius:'20px'}}>*/}
                    {/*            <p className='text-center p-0 m-0' style={{fontWeight:'900',fontSize:'14px'}}>{`${!isShowMore?'مشاهده بیشتر':'مشاهده همه'}`}</p>*/}
                    {/*        </div>*/}
                    {/*    </div>*/}
                    {/*:null}*/}
