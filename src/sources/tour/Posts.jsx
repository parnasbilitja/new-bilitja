        ...
        <div className="">
            ...
            <div class="box-blog-parent" >
                <div class="right-blog" >
                        <div class="info-blog">
                            <h6>
                                <a href={`/blogs/${posts[0]?.slug}`} class="link-light" >{posts[0]?.title}</a>
                            </h6>
                            <div class="date-info">
                        ...
                        <div class="left-blog">
                            <div class="top">
                                <div class="info-blog" >
                                    <h6>
                                    <a href={`/blogs/${posts[1]?.slug}`} class="link-light" >{posts[1]?.title}</a>
                                    </h6>
                                    <div class="date-info">
                                        <img src="https://hamnavaz.com/img/Watch.svg" width="20" alt="تاریخ-انتشار"/>
                        ...
                        <div class="bottom" >
                            <div class="bottom-left-blog">
                                <div class="info-blog">
                                    <h6>
                                        <a href={`/blogs/${posts[2]?.slug}`} class="link-light" >{posts[2]?.title}</a>
                                    </h6>
                                    <div class="date-info">
                                        <img src="https://hamnavaz.com/img/Watch.svg" width="20" alt="تاریخ-انتشار"/>
                            ...
                            <div class="bottom-right-blog" >
                                <div class="info-blog">
                                    <h6><a href={`/blogs/${posts[3]?.slug}`} class="link-light" >{posts[3]?.title}</a></h6>
                                    <div class="date-info">
                                        <img src="https://hamnavaz.com/img/Watch.svg" width="20" alt="تاریخ-انتشار"/>
