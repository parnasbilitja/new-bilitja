                        ...
                        <div className="d-flex mt-2 flex-column col-xl-5 col-lg-5 col-sm-4 col-12">
                            <div className="d-flex align-items-center justify-content-between">
                                <div className="d-flex align-items-center">
                                    <svg className="ms-3" xmlns="http://www.w3.org/2000/svg" width="17.326" height="20.086" viewBox="0 0 14.326 17.086">
                                        <g id="Bookmark" transform="translate(1 1)">
                                            <path id="Path_835" data-name="Path 835" d="M3.213,15.826h0l-.007,0a1.265,1.265,0,0,1-2-.941C1.121,13.721,1,11.579,1,8.464V8.408H1c0-1.236,0-2.314.089-3.213A5.283,5.283,0,0,1,1.795,2.8C2.7,1.413,4.432,1.011,7.16,1s4.469.388,5.372,1.787a5.329,5.329,0,0,1,.705,2.4c.088.9.089,1.982.089,3.219v.056c0,3.115-.121,5.257-.211,6.426a1.265,1.265,0,0,1-1.995.941h0l-.007,0c-.707-.483-1.361-1-1.87-1.41l-.009-.007c-.232-.184-.442-.352-.607-.474a3.743,3.743,0,0,0-.807-.482,1.755,1.755,0,0,0-1.313,0,3.744,3.744,0,0,0-.807.482h0c-.165.122-.375.29-.607.474l-.009.007C4.574,14.822,3.92,15.343,3.213,15.826Z" transform="translate(-1 -1)" fill="none" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} />
                                            <path id="Path_836" data-name="Path 836" d="M12,5a1.727,1.727,0,0,1,1.541.51c.514.512.514,2.227.514,2.911" transform="translate(-4.468 -2.262)" fill="none" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} />
                                        </g>
                                    </svg>
                                    <div className="text">
                                        <h5 className="font-bold title-custom p-0 m-0">تور لحظه آخری و آفری و ارزان قیمت</h5>
                                        <p className="subtitle-custom font-size-13 p-0 m-0">مشاهده مناسب ترین تور های لحظه آخری</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div className="box-special-tour" key={item.id}>
                                            ...
                                            <Link  href={`/tours/${item.endCity.nameEn}/${item.slug}`}>
                                                <a>
                                                    <div className="hover-info-img animated pulse">
                                                        ...
                                                        <Link href={`/tours/${item.endCity.nameEn}/${item.slug}`} className="view-details-more text-white" rel="noreferrer">
                                                            مشاهده جزئیات بیشتر
                                                        </Link>
                                                    </div>
                                                    <img
                                            ...
                                            <div className="day d-flex">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                    ...
                                                    <path id="Moon_1" data-name="Moon 1"
                                                          ...
                                                          transform="translate(0 0)" fill="#137cb6"/>
                                                </svg>
                                                <div>
                                        ...
                                        <div className="mid-info-tour-special">
                                            <div className="inner-mid-info-tour-special w-100" >
                                                <Link href={`/tours/${item.endCity.nameEn}/${item.slug}`} rel="noreferrer" className='cursor-pointer'>
                                                    <a>
                                                ...
                                                {/*  <span */}
                                                {/*      className="from" style={{fontWeight:'700'}}>{moment((item.transfers[0].dateTime.split(' ')[0])).locale('en').format('jYYYY/jMM/jDD')}</span>*/}
                                                ...
                                                {/*    <span className="to" style={{fontWeight:'700'}}>{moment((item.transfers[1].dateTime.split(' ')[0])).locale('en').format('jYYYY/jMM/jDD')}</span>*/}
                                                {/*</div>*/}
                                            </div>
