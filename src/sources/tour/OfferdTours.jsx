                  ...
                  <div className="box-special-tour" key={item.id}>
                      ...
                      <Link    href={`/tours/tourlist?origin=${item?.origin.code}&destination=${item?.destination.code}&date=${item?.departure_date}&nights=${item.night_num}&tour_type=package`}>
                          <a>
                              ...
                              {/*item.endCity.images[Math.floor(Math.random() * item.endCity.images.length)*/}
                              {item?.thumbnail?<img
                          ...
                          <div className="day d-flex">
                              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                  ...
                                  <path id="Moon_1" data-name="Moon 1"
                                        ...
                                        transform="translate(0 0)" fill="#e20000"/>
                              </svg>
                              <div>
                                  <span>{item.night_num} شب </span>
                                  <span>و</span>
                                  <span>{item.day_num} روز </span>
                              </div>
                                  ...
                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                      ...
                                      <g id="Ticket" transform="translate(-0.023)">
                                          <path id="Path_1168" data-name="Path 1168"
                                                ...
                                                fill="none" stroke="#212135" strokeWidth="2"/>
