            ...
            <div className="d-flex mt-2 flex-column col-xl-5 col-lg-5 col-sm-4 col-12">
                            <div className="d-flex align-items-center justify-content-between">
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="text">
                                        <h5 className="font-bold">تور لحظه آخری {props.name}</h5>
                                        <h6>ارزان ترین و با کیفیت ترین ها</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    :
                    <div className="hotelNotFound">متاسفانه برای {props.name} توری موجود نیست</div>
                        }    
        </div>
    );
};
