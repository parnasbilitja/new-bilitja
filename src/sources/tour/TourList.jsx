...
const TourList = (props) => {
    ...
    return (
        <div className="mt-5">
                ...
                <div className="d-flex align-items-center justify-content-between">
                    <div className="d-flex align-items-center">
                        ...
                        <div className="text mx-2" >
                            <h5 className="font-bold m-0 title-custom">تور لحظه آخری {props.name.slice(4,props.name.length)}</h5>
            ...
            { loading?
                <NewLoader/>:
                data.length===0 ?     <div className="hotelNotFound">متاسفانه برای تور {props.name.slice(4,props.name.length)} ، توری موجود نیست</div>: data
                    .map((item) => (
                                    ...
                                    <div className="tour-city">
                                        ...
                                        <div className="info-tour-city">
                                            ...
                                            <div className="text-price pt-1">
                                                ...
                                                <strong className="price-tour price-color me-2" style={{color:'#e20000 !important'}}>
