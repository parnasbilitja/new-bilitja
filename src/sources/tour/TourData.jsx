...
const TourData = ({currentCity, search, setSearch,route}) => {
    ...
    const getData = async (city) => {
        ...
        setLoading(true)
        await axios.get(`https://api.hamnavaz.com/api/v1/city/getCity/${city}`)
            .then(res => {
                    ...
                    <div className="about-city">
                        ...
                        <div className="title-s2" id="tours">
                            <div className="text">
                                ...
                                <div className='mr-2' style={{fontWeight:'600'}}> تور ارزان {data.name}</div>
                            </div>
                        </div>
                        ...
                        <div className="p-collapse-info-city" style={{textAlign:'justify !important'}}>
                            <div className="bg-text" style={{textAlign:'justify !important'}} dangerouslySetInnerHTML={{__html:data.description}} />
                        </div>
