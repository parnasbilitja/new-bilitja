...
const TourData = ({
  ...
  const getData = async (city) => {
    ...
    setLoading(true);
    await axios
      .get(`https://api.hamnavaz.com/api/v1/city/getCity/${slug}`)
      .then((res) => {
    ...
    <>
      {
        ...
        <>
          ...
          <div className="about-city">
            ...
            <div className="title-s2" id="tours">
              <div className="text">
                ...
                >
                  <g id="Document-align-2" transform="translate(0.5 0.5)">
                    ...
                    <path
                      ...
                      data-name="Path 903"
                      d="M7,7h6.383"
                      transform="translate(6.767 6.767)"
                      fill="none"
                      stroke="#e20000"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    ...
                    <path
                      ...
                      data-name="Path 904"
                      d="M7,12H28.278"
                      transform="translate(6.767 12.406)"
                      fill="none"
                      stroke="#e20000"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    ...
                    <path
                      ...
                      data-name="Path 905"
                      d="M14,17h6.383"
                      transform="translate(14.662 18.045)"
                      fill="none"
                      stroke="#e20000"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                ...
                <div className="mr-2" style={{ fontWeight: "600" }}>
                  {" "}
                  تور ارزان {city}
                </div>
              </div>
            ...
            <div class="parent-gallery">
              ...
              <div
                ...
                style={{
                  backgroundImage: `url(${
                    cityInfo.cityInfo.images &&
                    cityInfo.cityInfo.images[0] &&
                    cityInfo.cityInfo.images[0]
                  })`,
                }}
              ></div>
            ...
            <div
              className="p-collapse-info-city"
            ...
            >
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: cityInfo.cityInfo.description,
                }}
              />
            </div>
          </div>
          ...
          {data?.faq?.length > 1 && (
            <div className="col-lg-12 faq-con mt-4">
              ...
              {data?.faq?.map((faq, i) => {
                return (
                  <div className="mb-2">
                    <div
                      className="w-100 h-25 d-flex justify-content-between p-2"
                      style={{
                        borderRadius: "40px",
                        border: "3px solid #e0e0e0",
                        cursor: "pointer",
                      }}
                      onClick={() => setCollapseId(i)}
                    >
                      <div style={{ display: "flex" }}>
                        ...
                        <p
                          className="m-0 px-2 font-size-12"
                          style={{
                            color: "#646564",
                            fontWeight: "600",
                            fontSize: "14px",
                    ...
                    {collpaseId === i && (
                      <div>
                        <div className="p-2">
                          <p
                            className="m-0"
                            style={{ color: "#e20000", fontSize: "14px" }}
                          >
                            {faq.answer}
                          </p>
                        </div>
