...
const FlightPassengerForm = (props) => {
  ...
  function isFirstCharacterLetter(str) {
    ...
    var validFirstLetter = /[a-zA-Z]/.test(firstChar);
    if (!validFirstLetter) {
      props.messageBoxModify({
        color: false,
        message: "نخستین حرف شماره پاسپورت نباید رقم باشد!",
        state: true,
      });
      return false;
    }
  ...
  return (
    <div className={`${styles["passenger-form"]}`}>
      <div className="row d-flex justify-content-start col-md-12">
            ...
            >
              ...
              >
                <svg
                  ...
                  data-name="Layer 1"
                >
                  <path d="m9 12a6 6 0 1 0 -6-6 6.006 6.006 0 0 0 6 6zm0-10a4 4 0 1 1 -4 4 4 4 0 0 1 4-4zm9 17v5h-2v-5a3 3 0 0 0 -3-3h-8a3 3 0 0 0 -3 3v5h-2v-5a5.006 5.006 0 0 1 5-5h8a5.006 5.006 0 0 1 5 5zm3.414-9 2.543 2.543-1.414 1.414-2.543-2.543-2.543 2.543-1.414-1.414 2.543-2.543-2.543-2.543 1.414-1.414 2.543 2.543 2.543-2.543 1.414 1.414z" />
                </svg>
              </span>
              <span className="color-secondary error-message position-absolute top-50">
                &nbsp;
              </span>
            </div>
          ) : null}
        ...
        <div
          className={`"px-0 col-lg-12 col-md-12 col-sm-12 col-12 m-auto" ${styles["container"]}`}
        >
          <div className="row justify-content-between">
              ...
              <div className="pb-1 mt-1">
                <PrimaryTextInput
                  ...
                  onChange={(e) => {
                    ...
                    props.fillPassengersData("name", props.id, e.target.value);
                  }}
                  value={props.name}
                />
              </div>
            ...
            <div className=" col-lg-1 col-md-1 col-sm-4 col-6 px-0 mt-1">
              <PrimarySelectInput
                ...
                name="gender"
                onChange={(e) => {
                  props.fillPassengersData("gender", props.id, e.target.value);
                }}
              >
            ...
            <div className="col-lg-2 col-md-1 col-sm-4 col-6 px-0 padding-horizental-3px">
              ...
              <span className="color-secondary error-message position-absolute">
                {props.birthday == "" && err.birthdayErr
                  ? props.birthdayErr
                  : ""}
              </span>
            </div>
            <div
              className="national-codeData col-lg-2 col-md-2 col-sm-4 col-6 px-0 padding-horizental-3px mt-1 "
              ...
              {props.pathKind == 1 && props.nationality == "IR" ? (
                <>
                  <div
                    className={`d-flex align-items-center ${
                      props.pathKind == 3 ? styles["makhfi"] : ""
                    }`}
                  >
                    <PrimaryTextInput
                      style={{
                ...
                >
                  <PrimaryTextInput
                    ...
                    maxlength={9}
                    onChange={(e) => {
                      if (!isFirstCharacterLetter(e.target.value)) {
                        props.fillPassengersData("pasno", props.id, "");
                      } else {
                        props.fillPassengersData(
                          "pasno",
                          props.id,
            ...
            <div className="col-lg-2 col-md-1 col-sm-4 col-6 px-0 padding-horizental-3px mt-1">
              <div className={`d-flex align-items-center `}>
                <PrimaryTextInput
                  ext={
                    props.nationality == "IR" && props.pathKind == 1
                      ? "BEFORE"
                      : ""
                  }
                  disabled={
      ...
      <PopUp opened={state.open} closePopUp={managePopUpBirthdayCalendar}>
        <div style={{ padding: 15 }} class="text-center">
          <button className="py-2 px-4" onClick={() => setCalend(!calend)}   style={{border: '2px solid #e20000', borderRadius: '20px'}}>
      ...
      <PopUp opened={state.extOpen} closePopUp={managePopUpExtPasCalendar}>
