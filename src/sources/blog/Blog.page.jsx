...
const Blog = () => {
    ...
    useEffect(()=>{
        setLoading(true)
        const getData = async () => {
            await axios.get('https://echo.hamnavaz.com/posts')
            .then(res => {
          ...
          <div className='padd'>
              <div className="col-md-10 m-auto blog-list-parent marginTop120">
                  ...
                  <div className="list row">
                      {loading?
                          <div style={{marginTop:'4rem'}} className="d-flex align-items-center justify-content-center">
                                  ...
                                  <>
                                      <div className="box-blog col-12 col-md-6 col-lg-3">
                                          <div className="img" >
                                              ...
                                              <img className="img-fix" src={'https://hamnavaz.com'+post.thumbnail?.source} alt=""/>
                                          </div>
                                          <div style={{marginTop:'10px',display:"flex",flexDirection:'column',rowGap:'3px'}}>
                                              <Link href={`/blogs/${post.id}/${post.slug}`}  rel="noreferrer" >
                                              ...
                                              <div className="date">
                                                  ...
                                                  <span style={{fontSize:'14px', color:'#e20000'}}>منتشر شده در {MiladiToJalaliConvertor(post.lastUpdate) }</span>
                                              </div>
                                          </div>
