...
class UpdateVila extends React.Component {
  ...
  componentDidMount() {
    ...
    fetch(
      ...
      .then((res) => res.json())
      .then((data) => {
        const vilaTypeIndex = this.state.vilaTypes.findIndex(
          (type) => type == data.Eghamat[0].EghamatType
        );
        this.setState({
          vilaMainObjcet: {
            ...data.Eghamat[0],
          ...
          currentBuildingType: this.state.buildinType[vilaTypeIndex].findIndex(
            (type) => type == data.Eghamat[0].BuildingType
          ),
          notTheOwner:
            data.Eghamat[0].TelNo != "" || data.Eghamat[0].TelNo != null,
        });
      });
    // get villa's room by the id
    fetch(
    ...
    // get villa's facilities by the id
    fetch(
      `${
        globals.baseUrl
      }bj/eghamatEmkanat/view/${this.props.router.asPath.substr(21)}`
    )
      .then((res) => res.json())
      .then((data) => {
        this.setState({
    ...
    // get villa's rules by the id
    fetch(
      `${globals.baseUrl}bj/eghamatRules/view/${this.props.router.asPath.substr(
        21
      )}`
    )
      .then((res) => res.json())
    ...
    fetch(
      `${
        globals.baseUrl
      }bj/eghamatRoomEmkanat/view/0/1/${this.props.router.asPath.substr(21)}`
    )
      .then((res) => res.json())
      .then((data) => {
        this.setState({
          checkedFacilitiesForRoom: data.EghamatRoomEmkanat.map(
            (x) => x.EmkanatId
          ),
        });
      });
  ...
  // check if the related option is checked or not for => villa
  isItChecked = (name) => {
    try {
      ...
      <div className="container">
        <div>
          <div className="row panel-main-content">
            <h3 className="border-bottom-black-track font-size-16 font-bold-iransanse">
              ...
              <div className="row">
                ...
                <div className="col-lg-3 col-12 padding-3px">
                  ...
                  >
                    <PrimaryTextInput
                      ...
                      value={this.state.vilaMainObjcet.AdminName}
                      name="AdminName"
                ...
                <div className="col-lg-3 col-12 padding-3px">
                  ...
                  >
                    <PrimaryTextInput
                      ...
                      value={this.state.vilaMainObjcet.Name}
                      name="Name"
                      onChange={this.handleChangeInput}
                    />
                  </div>
                ...
                <div className="col-lg-3 col-12 padding-3px">
                  <input
                    ...
                    checked={this.state.notTheOwner}
                  />
                  <span className="font-bold-iransanse font-size-13">
                    مالک اقامتگاه نیستم
                  </span>
                  ...
                  >
                    <PrimaryTextInput
                      ...
                      value={this.state.vilaMainObjcet.TelNo}
                      name="TelNo"
                      onChange={this.handleChangeInput}
                    />
                  </div>
                ...
                <div className="col-12 padding-3px">
                  ...
                  >
                    <textarea
                      ...
                      value={this.state.vilaMainObjcet.Dsc}
                      name="Dsc"
                      onChange={this.handleChangeInput}
                    ></textarea>
                  </div>
          ...
          >
            ...
            <div className="col-lg-3 col-12 padding-3px">
              <PrimarySelectInput
                name="ProvinceId"
                value={this.state.vilaMainObjcet.ProvinceId}
                onChange={this.handleChangeInput}
              >
            ...
            <div className="col-lg-3 col-12 padding-3px">
              <PrimarySelectInput
                name="CityId"
                value={this.state.vilaMainObjcet.CityId}
                onChange={this.handleChangeInput}
              >
                <option value="-1"></option>
            ...
            <div className="col-lg-3 col-12 padding-3px">
              ...
              >
                <PrimaryTextInput
                  ...
                  value={this.state.vilaMainObjcet.AddressName}
                  name="AddressName"
                  onChange={this.handleChangeInput}
                />
              </div>
            ...
            <div className="col-12 padding-3px margin-top-10px">
              ...
              >
                <textarea
                  ...
                  value={this.state.vilaMainObjcet.Address}
                  className="form-input primary-text"
                  name="Address"
                  onChange={this.handleChangeInput}
                ></textarea>
          ...
          >
            ...
            <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
              <input
                ...
                checked={this.isItChecked("EcoFlag")}
              />
            ...
            <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
              <input
                ...
                name="LuxFlag"
                onChange={this.handleChangeCheckbox}
                checked={this.isItChecked("LuxFlag")}
              />
              <label class="form-check-label font-bold-iransanse">
                &nbsp; لوکس
              </label>
            ...
            <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
              <input
                ...
                name="NormalFlag"
                onChange={this.handleChangeCheckbox}
                checked={this.isItChecked("NormalFlag")}
              />
              <label class="form-check-label font-bold-iransanse">
                &nbsp; معمولی
              </label>
            ...
            <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
              <input
                ...
                name="SupLuxFlag"
                onChange={this.handleChangeCheckbox}
                checked={this.isItChecked("SupLuxFlag")}
              />
              <label class="form-check-label font-bold-iransanse">
                &nbsp; سوپر لوکس
              </label>
            ...
            <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
              <input
                ...
                name="TakhfifFlag"
                onChange={this.handleChangeCheckbox}
                checked={this.isItChecked("TakhfifFlag")}
              />
              <label class="form-check-label font-bold-iransanse">
                &nbsp; تخفیف دار
              </label>
          ...
          >
            ...
            <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
              <input
                ...
                checked={this.isItCheckedForRoom("KohViewFlag")}
              />
              <label class="form-check-label font-bold-iransanse">
                &nbsp; کوهستانی
              </label>
            ...
            <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
              <input
                ...
                name="JangalViewFlag"
                onChange={this.roomHandleChangeCheckbox}
                checked={this.isItCheckedForRoom("JangalViewFlag")}
              />
              <label class="form-check-label font-bold-iransanse">
                &nbsp; جنگل
              </label>
            ...
            <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
              <input
                ...
                name="SeaViewFlag"
                onChange={this.roomHandleChangeCheckbox}
                checked={this.isItCheckedForRoom("SeaViewFlag")}
              />
              <label class="form-check-label font-bold-iransanse">
                &nbsp; دریا
              </label>
            ...
            <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
              <input
                ...
                name="PayeViewFlag"
                onChange={this.roomHandleChangeCheckbox}
                checked={this.isItCheckedForRoom("PayeViewFlag")}
              />
              <label class="form-check-label font-bold-iransanse">
                &nbsp; کوهپایه
              </label>
            ...
            <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
              <input
                ...
                name="CityViewFlag"
                onChange={this.roomHandleChangeCheckbox}
                checked={this.isItCheckedForRoom("CityViewFlag")}
              />
              <label class="form-check-label font-bold-iransanse">
                &nbsp; شهری
              </label>
          ...
          >
            ...
            <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
              <input
                ...
                name="RostaFlag"
                onChange={this.handleChangeCheckbox}
                checked={this.isItChecked("RostaFlag")}
              />
              <label class="form-check-label font-bold-iransanse">
                &nbsp; روستایی
              </label>
            ...
            <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
              <input
                ...
                name="SahelFlag"
                onChange={this.handleChangeCheckbox}
                checked={this.isItChecked("SahelFlag")}
              />
              <label class="form-check-label font-bold-iransanse">
                &nbsp; ساحلی
              </label>
            ...
            <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
              <input
                ...
                name="ShahrakFlag"
                onChange={this.handleChangeCheckbox}
                checked={this.isItChecked("ShahrakFlag")}
              />
              <label class="form-check-label font-bold-iransanse">
                &nbsp; شهرک
              </label>
            ...
            <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
              <input
                ...
                name="YeylaFlag"
                onChange={this.handleChangeCheckbox}
                checked={this.isItChecked("YeylaFlag")}
              />
              <label class="form-check-label font-bold-iransanse">
                &nbsp; ییلاقی
              </label>
            ...
            <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
              <input
                ...
                name="ShahrFlag"
                onChange={this.handleChangeCheckbox}
                checked={this.isItChecked("ShahrFlag")}
              />
              <label class="form-check-label font-bold-iransanse">
                &nbsp; شهری
              </label>
            ...
            <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
              <input
                ...
                name="JangalFlag"
                onChange={this.handleChangeCheckbox}
                checked={this.isItChecked("JangalFlag")}
              />
              <label class="form-check-label font-bold-iransanse">
                &nbsp; جنگلی
              </label>
            ...
            <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
              <input
                ...
                name="KohFlag"
                onChange={this.handleChangeCheckbox}
                checked={this.isItChecked("KohFlag")}
              />
              <label class="form-check-label font-bold-iransanse">
                &nbsp; کوهستانی
              </label>
                    ...
                    <div className="col-lg-7 col-7 padding-3px">
                      ...
                      >
                        <PrimaryTextInput
                          name="Metraj"
                          onChange={this.handleChangeInput}
                          value={this.state.vilaMainObjcet.Metraj}
                        />
                        <span className="color-secondary error-message font-size-14">
                          {this.state.errors.landMetraj}
                        </span>
                      </div>
                    </div>
                    <div className="col-lg-5 col-5 text-right">
                    ...
                    <div className="col-lg-7 col-7 padding-3px">
                      ...
                      >
                        <PrimaryTextInput
                          ...
                          value={this.state.roomObject.Metraj}
                        />
                        <span className="color-secondary error-message font-size-14">
                          {this.state.errors.villaMetraj}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-7 col-7 padding-3px">
                      <PrimarySelectInput
                        name="Cap"
                        onChange={this.roomHandleChangeInput}
                        value={this.state.roomObject.Cap}
                      >
                    ...
                    <div className="col-lg-7 col-7 padding-3px">
                      <PrimarySelectInput
                        name="CapMax"
                        onChange={this.roomHandleChangeInput}
                        value={this.state.roomObject.CapMax}
                      >
                        {arrayOfThirty.map((number) => (
                          <option value={number}>{number}</option>
                        ))}
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-7 col-7 padding-3px">
                      <PrimarySelectInput
                        name="RoomCount"
                        onChange={this.roomHandleChangeInput}
                        value={this.state.roomObject.RoomCount}
                      >
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-7 col-7 padding-3px">
                      <PrimarySelectInput
                        name="Takht1Count"
                        onChange={this.roomHandleChangeInput}
                        value={this.state.roomObject.Takht1Count}
                      >
                        {arrayOfTen.map((number) => (
                          <option value={number}>{number}</option>
                        ))}
                    ...
                    <div className="col-lg-7 col-7 padding-3px">
                      <PrimarySelectInput
                        name="Takht2Count"
                        onChange={this.roomHandleChangeInput}
                        value={this.state.roomObject.Takht2Count}
                      >
                        {arrayOfTen.map((number) => (
                          <option value={number}>{number}</option>
                        ))}
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-7 col-7 padding-3px">
                      <PrimarySelectInput
                        name="ToshakCount"
                        onChange={this.roomHandleChangeInput}
                        value={this.state.roomObject.ToshakCount}
                      >
                        {arrayOfTen.map((number) => (
                          <option value={number}>{number}</option>
                        ))}
            ...
            {this.state.facilities.map((facility) => (
              <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
                <input
                  ...
                  checked={this.state.checkedFacilities.find(
                    (x) => x == facility.EmkanatId
                  )}
                />
            ...
            {this.state.facilitiesroom.map((facilitiesroom) => (
              <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
                <input
                  ...
                  checked={this.state.checkedFacilitiesForRoom.find(
                    (x) => x == facility.EmkanatId
                  )}
                />
                <label class="form-check-label">
