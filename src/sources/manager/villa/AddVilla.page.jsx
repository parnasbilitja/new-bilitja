...
class AddVilaDesktop extends React.Component {
    ...
    validation = () => {
        ...
        let nameError, AdminName, TelNo, Dsc, Province, City, AddressName, Address
            , typevilla, villaView, villaLocation,
            landMetraj, villaMetraj, facilities
            ...
            <div className="container">
                <div>
                            ...
                            <div className="row margin-top-20px">
                                <div className="col-12 padding-3px">
                                    ...
                                    <div className={` form-input-border  ${styles['form-input-border-private']} `} style={{ height: "auto" }}>
                                        <textarea rows="10" className="form-input primary-text" name="Dsc" onChange={this.handleChangeInput}>
                    ...
                    <div className={ `row ${styles['panel-main-content']}  margin-top-10px`}>
                        ...
                        <div className="col-lg-3 col-12 padding-3px">
                            <PrimarySelectInput name="CityId" onChange={this.handleChangeInput}>
                                <option value="-1" selected></option>
                        ...
                        <div className="col-12 padding-3px margin-top-10px">
                            <div className={` form-input-border  ${styles['form-input-border-private']} `} style={{ height: "auto" }}>
                                <textarea rows="5" placeholder="آدرس کامل اقامتگاه ( آمل-خیابان 1- کوچه 2 -پلاک 110)" className="form-input primary-text" name="Address" onChange={this.handleChangeInput}>
                    ...
                    <div className={`row ${styles['panel-main-content']} margin-top-10px`}>
                        <span className="color-secondary error-message font-size-14"> {this.state.errors.typevilla}</span>
                        ...
                        <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
                            <input class="form-check-input" type="checkbox" name="LuxFlag" onChange={this.handleChangeCheckbox} />
                            <label class="form-check-label font-bold-iransanse">&nbsp; لوکس</label>
                        </div>
                        <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
                            <input class="form-check-input" type="checkbox" name="NormalFlag" onChange={this.handleChangeCheckbox} />
                            <label class="form-check-label font-bold-iransanse">&nbsp; معمولی</label>
                        </div>
                        <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
                            <input class="form-check-input" type="checkbox" name="SupLuxFlag" onChange={this.handleChangeCheckbox} />
                            <label class="form-check-label font-bold-iransanse">&nbsp; سوپر لوکس</label>
                        </div>
                        <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
                            <input class="form-check-input" type="checkbox" name="TakhfifFlag" onChange={this.handleChangeCheckbox} />
                            <label class="form-check-label font-bold-iransanse">&nbsp; تخفیف دار</label>
                        </div>

                    </div>
                    <div className={`row ${styles['panel-main-content']} margin-top-10px`}>
                        <span className="color-secondary error-message font-size-14"> {this.state.errors.villaView}</span>
                        ...
                        <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
                            <input class="form-check-input" type="checkbox" name="JangalViewFlag" onChange={this.roomHandleChangeCheckbox} />
                            <label class="form-check-label font-bold-iransanse">&nbsp; جنگل</label>
                        </div>
                        <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
                            <input class="form-check-input" type="checkbox" name="SeaViewFlag" onChange={this.roomHandleChangeCheckbox} />
                            <label class="form-check-label font-bold-iransanse">&nbsp; دریا</label>
                        </div>
                        <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
                            <input class="form-check-input" type="checkbox" name="PayeViewFlag" onChange={this.roomHandleChangeCheckbox} />
                            <label class="form-check-label font-bold-iransanse">&nbsp; کوهپایه</label>
                        </div>
                        <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
                            <input class="form-check-input" type="checkbox" name="CityViewFlag" onChange={this.roomHandleChangeCheckbox} />
                            <label class="form-check-label font-bold-iransanse">&nbsp; شهری</label>
                        </div>
                    </div>
                    <div className={`row ${styles['panel-main-content']} margin-top-10px`}>
                        <span className="color-secondary error-message font-size-14">{this.state.errors.villaLocation}</span>
                        ...
                        <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
                            <input class="form-check-input" type="checkbox" name="SahelFlag" onChange={this.handleChangeCheckbox} />
                            <label class="form-check-label font-bold-iransanse">&nbsp; ساحلی</label>
                        </div>
                        <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
                            <input class="form-check-input" type="checkbox" name="ShahrakFlag" onChange={this.handleChangeCheckbox} />
                            <label class="form-check-label font-bold-iransanse">&nbsp; شهرک</label>
                        </div>
                        <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
                            <input class="form-check-input" type="checkbox" name="YeylaFlag" onChange={this.handleChangeCheckbox} />
                            <label class="form-check-label font-bold-iransanse">&nbsp; ییلاقی</label>
                        </div>
                        <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
                            <input class="form-check-input" type="checkbox" name="ShahrFlag" onChange={this.handleChangeCheckbox} />
                            <label class="form-check-label font-bold-iransanse">&nbsp; شهری</label>
                        </div>
                        <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
                            <input class="form-check-input" type="checkbox" name="JangalFlag" onChange={this.handleChangeCheckbox} />
                            <label class="form-check-label font-bold-iransanse">&nbsp; جنگلی</label>
                        </div>
                        <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
                            <input class="form-check-input" type="checkbox" name="KohFlag" onChange={this.handleChangeCheckbox} />
                            <label class="form-check-label font-bold-iransanse">&nbsp; کوهستانی</label>
                        </div>
                    </div>
                    <div className={ `row ${styles['panel-main-content']}  margin-top-10px`}>
                                ...
                                <div className="col-lg-10 col-10 no-padding">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-7 col-7 padding-3px">
                                            <div className={` form-input-border  ${styles['form-input-border-private']} `}>
                                                <PrimaryTextInput name="Metraj" onChange={this.handleChangeInput} />
                                            </div>
                                        </div>
                                        <div className="col-lg-5 col-5 text-right">
                                        ...
                                        <div className="col-lg-7 col-7 padding-3px">
                                            <div className={` form-input-border  ${styles['form-input-border-private']} `}>
                                                <PrimaryTextInput name="Metraj" onChange={this.roomHandleChangeInput} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-10 col-10 no-padding">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-7 col-7 padding-3px">
                                            <PrimarySelectInput name="Cap" onChange={this.roomHandleChangeInput}>
                                                {
                                        ...
                                        <div className="col-lg-7 col-7 padding-3px">
                                            <PrimarySelectInput name="CapMax" onChange={this.roomHandleChangeInput}>
                                                {
                                                    arrayOfThirty.map(number => (
                                                        <option value={number}>{number}</option>
                                                    ))
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-10 col-10 no-padding">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-7 col-7 padding-3px">
                                            <PrimarySelectInput name="RoomCount" onChange={this.roomHandleChangeInput}>
                                                {
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-10 col-10 no-padding">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-7 col-7 padding-3px">
                                            <PrimarySelectInput name="Takht1Count" onChange={this.roomHandleChangeInput}>
                                                {
                                                    arrayOfTen.map(number => (
                                                        <option value={number}>{number}</option>
                                                    ))
                                        ...
                                        <div className="col-lg-7 col-7 padding-3px">
                                            <PrimarySelectInput name="Takht2Count" onChange={this.roomHandleChangeInput}>
                                                {
                                                    arrayOfTen.map(number => (
                                                        <option value={number}>{number}</option>
                                                    ))
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-10 col-10 no-padding">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-7 col-7 padding-3px">
                                            <PrimarySelectInput name="ToshakCount" onChange={this.roomHandleChangeInput}>
                                                {
                                                    arrayOfTen.map(number => (
                                                        <option value={number}>{number}</option>
                                                    ))
                    ...
                    <div className={ `row ${styles['panel-main-content']}  margin-top-10px`}>
                        ...
                        <h3 className={` ${stylesTrack['border-bottom-black-track']} font-size-16 font-bold-iransanse margin-bottom-5px`}>امکانات اقامتگاه </h3>
                        {
                            this.state.facilities.map(facility => (
                                <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
                                    <input class="form-check-input" type="checkbox" name={facility.EmkanatId} onChange={this.onCheckFacility} />
                    ...
                    <div className={ `row ${styles['panel-main-content']}  margin-top-10px`}>
                        ...
                        <h3 className={` ${stylesTrack['border-bottom-black-track']} font-size-16 font-bold-iransanse margin-bottom-5px`}>امکانات اتاق اقامتگاه </h3>
                        {
                            this.state.facilities.map(facility => (
                                <div className="col-lg-2 col-4 no-padding form-check form-check-inline no-margin">
                                    <input class="form-check-input" type="checkbox" name={facility.EmkanatId} onChange={this.onCheckRoomFacility} />
                                    <label class="form-check-label">&nbsp; {facility.EmkanatName}</label>
                                </div>
                            ))
                        }
