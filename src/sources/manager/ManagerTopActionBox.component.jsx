...
class ManagerTopActionBox extends React.Component {
    ...
    render() {
        return (
            <>
                <div className={` ${styles['manager-top-action-box']} hidden-xs`} onClick={this.props.handleClick}>
                    <span className="pull-right font-size-13 font-bold-iransanse">افزودن</span>
                    <FontAwesomeIcon className={`pull-left  ${styles['red-icon']} `} icon={faPlusCircle} />
