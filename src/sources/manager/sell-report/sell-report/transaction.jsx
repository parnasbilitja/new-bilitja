    ...
    return (
        <>
            <div className="d-flex flex-column align-items-center  w-100">
                <div className={style["title-page-sales-report"]}>
                    <h6>تراکنش ها</h6>
                ...
                <div className={style['parent-sales-report']}>
                    <div className={style['header-parent-sales-report-transaction']}>
                        ...
                        <span className="font-bold-iransanse font-size-12">   شماره پیگیری   </span>
                        <span className="font-bold-iransanse font-size-12">    مبلغ  </span>
                        <span className="font-bold-iransanse font-size-12">   وضعیت   </span>
                    </div>
                    <div className={style['body-search-report-transaction']}>
                        <span>...</span>
                        <input type="text"/>
                        <input type="text"/>
                        <input type="text"/>
                    ...
                    <div className={style['body-parent-report-transaction']}>
