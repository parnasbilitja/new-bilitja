    ...
    <div className={`${styles["home-flight-form"]}`}>
      <div className="position-relative">
        ...
        <div
          ...
          <svg xmlns="http://www.w3.org/2000/svg" id="_044-Departures" data-name="044-Departures" width="39.655" height="27.135" viewBox="0 0 39.655 27.135">
            <path id="Path_1760" data-name="Path 1760" d="M.782,406.966h38.09a.782.782,0,1,1,0,1.564H.782a.782.782,0,1,1,0-1.564Z" transform="translate(0 -381.396)" fill="#808285"/>
            <path id="Path_1761" data-name="Path 1761" d="M39.736,93.474l-5.765,3.94a7.742,7.742,0,0,1-7.611.621l-5.68-2.654a.782.782,0,0,1,.662-1.417l5.679,2.654a6.172,6.172,0,0,0,6.066-.5l4.768-3.259-2.146-1.316L30.189,93.38a.782.782,0,0,1-.58-.035l-6.58-3.1a.782.782,0,0,1-.151-1.322L30.139,83.2l-2.824-1.441L14.254,85.893a.783.783,0,0,1-.569-.038L4.948,81.749a2.117,2.117,0,0,0-2.666,1.01,2.04,2.04,0,0,0,.962,2.762l11.739,5.484a.782.782,0,1,1-.662,1.417L2.581,86.939a3.6,3.6,0,0,1-1.7-4.879,3.7,3.7,0,0,1,4.691-1.744l.026.012,8.475,3.982,13.075-4.137a.782.782,0,0,1,.591.049l4.2,2.142a.782.782,0,0,1,.129,1.311L24.84,89.369,29.993,91.8l5.571-1.848a.783.783,0,0,1,.655.076L39.7,92.162a.782.782,0,0,1,.032,1.312Z" transform="translate(-0.462 -80.036)" fill="#808285"/>
            <path id="Path_1762" data-name="Path 1762" d="M275.938,238.18a.781.781,0,1,1-1.038.377A.781.781,0,0,1,275.938,238.18Z" transform="translate(-258.229 -225.743)" fill="#808285"/>
          </svg>
      ...
      <div>
        ...
        >
          {" "}
          <svg xmlns="http://www.w3.org/2000/svg" width="37.922" height="29.591" viewBox="0 0 37.922 29.591">
            <g id="_046-arrivals" data-name="046-arrivals" transform="translate(0 0)">
              <path id="Path_1767" data-name="Path 1767" d="M63.513,65.451a7.4,7.4,0,0,1-5.178,5.15l-5.787,1.565a.748.748,0,1,1-.391-1.444l5.787-1.565a5.9,5.9,0,0,0,4.127-4.1l1.473-5.323-2.38.362-2.9,4.746a.748.748,0,0,1-.445.332l-6.72,1.8a.748.748,0,0,1-.926-.873l1.775-8.66-2.952.689L42,69.2a.748.748,0,0,1-.439.323l-8.918,2.391A2.025,2.025,0,0,0,31.317,74.3a1.951,1.951,0,0,0,2.407,1.425l11.96-3.236a.748.748,0,1,1,.391,1.444l-11.96,3.236a3.47,3.47,0,0,1-.908.122,3.452,3.452,0,0,1-3.343-2.639,3.541,3.541,0,0,1,2.351-4.168l.026-.007,8.649-2.319,7-11.089a.747.747,0,0,1,.462-.329l4.388-1.025a.748.748,0,0,1,.9.879l-1.767,8.619L57.14,63.8l2.93-4.787a.748.748,0,0,1,.525-.349l3.865-.588a.748.748,0,0,1,.833.939Z" transform="translate(-29.626 -55.689)" fill="#808285"/>
              <path id="Path_1768" data-name="Path 1768" d="M237.923,268.478a.747.747,0,1,1-.916-.526A.747.747,0,0,1,237.923,268.478Z" transform="translate(-217.713 -252.051)" fill="#808285"/>
              <path id="Path_1769" data-name="Path 1769" d="M.748,431.31H37.174a.748.748,0,0,1,0,1.5H.748a.748.748,0,1,1,0-1.5Z" transform="translate(0 -403.214)" fill="#808285"/>
            </g>
          </svg>
      ...
      <div className=" without-focus">
        ...
        <PrimaryButton type={'index'}
          style={{ height: "55px", marginTop: "7px",fontSize:'14px',fontWeight:'600',textAlign:'center',borderRadius: "10px",cursor:'pointer'}}
          value={
