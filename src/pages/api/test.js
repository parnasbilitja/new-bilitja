...
export default function handler(req,res) {
 ...
 //    [Route("api/appCallBackBank/saman/{state}/{refNum}/{resNum}/{mid}")]
           fetch(`${globals.baseUrl}appCallBackBank/saman/${body.message.StateCode}/${body.message.RefNum}/${body.message.ResNum}/${body.message.MID}`)
     ...
     fetch(`${globals.baseUrl}appCallBackBank/saman/${req.query.StateCode}/${req.query.RefNum}/${req.query.ResNum}/${req.query.MID}`)
         .then(res => res.json()).then(data => {
         // res.send(data); 
             switch (data.status ) {
                   case "-100":
