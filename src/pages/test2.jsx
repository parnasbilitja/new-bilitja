...
//              `https://api.bilitja.com/api/OnlinePay/api/onlinePay/reference/OUPHKE/1a157116-a01a-4027-ab10-74098ac63815`
  `https://api.bilitja.com/api/appCallBackBank/AppCallBackBank/saman`,
 //   );
   {
    method: "POST",
    headers: { "Content-Type": "application/json" },
