...
const ReservationConfirmation = () => {
    ...
    const getReservedData = (refcode) => {
        ...
        axios.get(`https://hotelobilit-api.iran.liara.run/api/v2/reserves/${refcode}`).then((res) => {
    ...
    const EditClickHandler = (passengersArr) => {
        axios.patch(`https://hotelobilit-api.iran.liara.run/api/v2/reserves/${router.query.ref_code}`, {
            reserves: [{
                reserve_id: targetedReservedId, passengers: [...passengersArr]
            }],
    ...
    return (<>
        ...
        <div className={styles["reserveinfo_container"]}>
            ...
            <TourDetailLabel flightDet={hotelDet?.data?.reserves[0]?.flight} stayCount={router?.query?.stayCount} gallary={hotelDet?.data?.hotel.gallery}/>
                ...
                {reservedRoom?.map((reservedroom) => {
                    ...
                    >
                        ...
                        <div style={{overflowX: 'scroll'}}>
                            <AnimatePresence>
                                {reservedroom.id === roomId ? (// <motion.div
                                    //   variants={variants}
                                    //   initial="initial"
                                    //   animate="animate"
                                    //   exit="exit"
