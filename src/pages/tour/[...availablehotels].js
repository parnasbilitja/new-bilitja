...
const availableHotels = () => {
    ...
    const HotelCall=(page=1)=>{
        ...
        axios
            .post(`https://hotelobilit-api.iran.liara.run/api/v1/hotels/search?page=${page}`, {
                date: date,
                                ...
                                <div className={styles.searchContainer}>
                                    <div>
                                        <div style={{display:'flex',justifyContent:'space-between',width:'100%'}}>
                                            ...
                                            <div className={styles['closeBtn']} onClick={()=>setShowSearchBox(!showSearchBox)}>
                                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="15" height="15" viewBox="0 0 30 30" fill="#137cb6">
                                                    ...
                                                    <div className={styles.hotelContainer}>
                                                        <div className={styles.hotelDetail}>
                                                            ...
                                                            <div className={styles.hotelNameDetail}>
                                                                {hotel.is_domestic ? (
                                                                    <div>
                                                                        <p className={styles.faName}>{hotel?.title}</p>
