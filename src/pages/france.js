...
import {Content, FranceContent} from '../Utils/CityContent'
                        ...
                        <div style={{padding:'.5rem'}}>
                            ...
                            <div className='mt-3'>
                                <h2 style={{
                                    ...
                                    margin: '1rem 0',
                                    width: '100%'
                                }}>{FranceContent.citytitle.title}</h2>
                                <p style={{
                                    fontSize: '16px', textAlign: 'justify', lineHeight: '24px'
                                }}>{FranceContent.citytitle.description}</p>
                            </div>
                            ...
                            <div className='mt-3'>
                                <h2 style={{
                                    ...
                                    marginTop: 0,
                                    width: '100%'
                                }}>جاذبه‌های دیدنی پاریس </h2>

                                <ol style={{padding:'0 20px'}}>

                                    <>
                                        {
                                            FranceContent.attractions.map(att=>{
                                                return(
                                                    ...
                                                    <li style={{margin:'30px 0'}}>
                                                        ...
                                                        <div style={{width:'100%',height:'auto'}}>
                                                            ...
                                                            <img src={att.imgLoc} alt="" style={{width:'100%',height:'100%',objectFit:'cover'}}/>
                                                        </div>
                                ...
                                <>
                                    {FranceContent.travelloffer.map(offer=>{
                                        return(
                                            <div className='mt-1'>
                                                <h2 style={{
                                                    fontSize: '22px',
                                    ...
                                    {FranceContent.services.map(s=>{
                                        return(
                                            <div className='mt-4'>
                                                ...
                                                <ul style={{listStyleType:'circle',marginRight:'30px'}}>
                                                    {
                                                        s.data.map(d=>{
                                                            return(
                                                                <li>{d}</li>
