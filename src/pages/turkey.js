...
const Turkey = () => {
    const [currentCity, setCurrentCity] = useState('تور-استانبول')
    ...
    return (<>
            <Head>
                <title>
                    رزرو تور گردشگری ترکیه | استانبول | سایت بلیطجا
                </title>
                <meta
                    name="description"
                    content="تور استانبول و تخفیف ویژه‌ی عید رزرو تور ترکیه با ارزانترین قیمت. بهترین مقصد سفر عیدانه با بلیطجا. خرید و رزرو تور گردشگری شهر زیبای استانبول با بهترین و لوکس ترین شرایط سایت بلیطجا."
                    key="desc"
                />
            </Head>
            <NavHandler/>
