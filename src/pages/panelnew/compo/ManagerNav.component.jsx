...
const ManagerNav = (props) => {
  ...
  useEffect(() => {
    ...
    console.log(width);
    width > 826 ? setOpend(true) : setOpend(false);
  }, [width]);
    ...
    <div>
      ...
      {isOpend && (
        ...
        >
          ...
          <div
            className={
              myRouter.asPath === "/panelnew/profile"
            ...
            onClick={() => {
              myRouter.push("/panelnew/profile");
              if (width <= 826) {
                setOpend(false);
              }
          ...
          <div
            className={
              myRouter.asPath === "/panelnew/dashboard"
            ...
            onClick={() => {
              myRouter.push("/panelnew/dashboard");
              if (width <= 826) {
                setOpend(false);
              }
            }}
          ...
          <div
            className={
              myRouter.asPath === "/panelnew/flight-sell-report"
                ? `${styles["active-tab"]} ${styles["manager-nav-one-row"]} d-flex align-items-center flex-row-reverse cursor-pointer panel-menu-item-active`
                : `${styles["manager-nav-one-row"]} d-flex align-items-center flex-row-reverse cursor-pointer panel-menu-item`
            }
            onClick={() => {
              myRouter.push("/panelnew/flight-sell-report");
              if (width <= 826) {
                setOpend(false);
              }
            }}
          ...
          <div
            className={
              myRouter.asPath === "/panelnew/price-handling"
                ? `${styles["active-tab"]} ${styles["manager-nav-one-row"]} d-flex align-items-center flex-row-reverse cursor-pointer panel-menu-item-active`
                : `${styles["manager-nav-one-row"]} d-flex align-items-center flex-row-reverse cursor-pointer panel-menu-item`
            }
            onClick={() => {
              myRouter.push("/panelnew/price-handling");
              if (width <= 826) {
                setOpend(false);
              }
            }}
          ...
          <div
            className={
              myRouter.asPath === "/panel/villas/search"
                ? `${styles["active-tab"]} ${styles["manager-nav-one-row"]} d-flex align-items-center flex-row-reverse cursor-pointer panel-menu-item-active`
                : `${styles["manager-nav-one-row"]} d-flex align-items-center flex-row-reverse cursor-pointer panel-menu-item`
            }
            onClick={() => {
          ...
          <div
            className={
              myRouter.asPath === "/panel/city/show"
                ? `${styles["active-tab"]} ${styles["manager-nav-one-row"]} d-flex align-items-center flex-row-reverse cursor-pointer panel-menu-item-active`
                : `${styles["manager-nav-one-row"]} d-flex align-items-center flex-row-reverse cursor-pointer panel-menu-item`
            }
            onClick={() => {
          ...
          <div
            className={
              myRouter.asPath === "/panel/facility/show"
                ? `${styles["active-tab"]} ${styles["manager-nav-one-row"]} d-flex align-items-center flex-row-reverse cursor-pointer panel-menu-item-active`
                : `${styles["manager-nav-one-row"]} d-flex align-items-center flex-row-reverse cursor-pointer panel-menu-item`
            }
            onClick={() => {
          ...
          <div
            className={
              myRouter.asPath === "/panel/rule/show"
                ? `${styles["active-tab"]} ${styles["manager-nav-one-row"]} d-flex align-items-center flex-row-reverse cursor-pointer panel-menu-item-active`
                : `${styles["manager-nav-one-row"]} d-flex align-items-center flex-row-reverse cursor-pointer panel-menu-item`
            }
            onClick={() => {
          ...
          >
            <div>
              ...
              >
                ...
                />
                <path
                  d="M29.0625 19.6699V15.8358"
                  stroke="#013136"
                  strokeWidth={2}
                  strokeLinecap="round"
                />
                <path
                  d="M8.02734 17.7539H15.6766"
                  stroke="#013136"
                  strokeWidth={2}
                  strokeLinecap="round"
                />
                <path
                  d="M8.02734 25.4219H15.6766"
                  stroke="#013136"
                  strokeWidth={2}
                  strokeLinecap="round"
                />
                <path
                  d="M8.02734 33.0898H15.6766"
                  stroke="#013136"
                  strokeWidth={2}
                  strokeLinecap="round"
                />
