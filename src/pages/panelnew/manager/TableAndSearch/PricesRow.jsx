...
const PricesRow = ({ foroshAll, buyAll, Profit, Transaction, reserving }) => {
  return (
    <div className="d-detail d-flex align-items-center">
      ...
      <div
        className={`detail flex-7 m-flex-${Transaction == true ? "5" : "35"}`}
      >
        <span className="font-size-14"></span>
      </div>
      <div
        className={`detail flex-7 m-flex-${Transaction == true ? "5" : "40"}`}
      >
        <span className="font-size-14"></span>
      </div>
      <div
        className={`detail flex-7 m-flex-${Transaction == true ? "2" : "40"}`}
      >
        <span className="font-size-14"></span>
      </div>
      <div
        className={`detail flex-7 m-flex-${Transaction == true ? "2" : "28"}`}
      >
        <span className="font-size-14"></span>
      </div>
      <div
        className={`detail flex-8 m-flex-${Transaction == true ? "0" : "28"}`}
      >
        <span className="font-size-14"></span>
      </div>
      ...
      <div
        className={`detail flex-${Transaction == true ? "8" : "7"} m-flex-${
          Transaction == true ? "0" : "10"
        }`}
      >
        <span className="font-size-14"></span>
      </div>
      ...
      <div
        className={`detail flex-${Transaction == true ? "12" : "7"} m-flex-35`}
      >
